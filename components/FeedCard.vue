...
a {
 ...
 .investment__investment,  .investment__ownership,  .investment__valuation {
    width: 33.3%;
}
 .denomination {
    color: #888;
 ...
 .investment__valuation {
    padding: 0 1.25rem;
    text-align: right;
}
 .investment__ownership {
    padding: 0 1.25rem;
    text-align: center;
}
.investment__investment {
